<body>
    ...
    <nav>
        <ul id="nav">
            ...
            echo anchor('nadairreal/dashboard/' . $this->uri->segment(3) . '/' . $t['id_categoria'], '<span>' . $t["titulo"] . $count, ($this->uri->segment(4) == $t['id_categoria'] ? "class=active" : ""))
                    ?>
    ...
    <section id="content">
        ...
        <div class="g12">
            ...
            <h3 class="tema"><span class="tema">TEMA: <?php echo $temas[0]['tema'] ?></span><span class="fecha-inicio"> Proximo N.I: <?php echo tiempo_transcurrido($temas[0]['fecha_inicio']); ?></span> <?php echo $_SESSION['username'] ?><h3>
                    <h1 class="titulo_categoria" id="<?php echo $categorias[0]['titulo']; ?>" style="font-size: 60px;"><?php echo $categorias[0]['titulo']; ?> </h1>
                    ...
                    <div class="b-c"  style="display:none; box-shadow: 10px 14px 100px 10px #999; position:fixed; top:-112%; z-index: 1; right: 20%">
                    </div>
                    ...
                    <div class="widgets" style="clear:both; "> 
                        ...
                        <div class="widget" id="ajax_widget_reload" data-load="/nadairreal/chat/<?php echo $this->uri->segment(3) ?>/<?php echo $this->uri->segment(4) ?>" data-reload="1580" data-remove-content="false">
                    ...
                    <footer>"...pero confiad, Yo he vencido al mundo." Juan 16</footer>
                    </body>
                    </html>