...
<div id="container_show">
    <div id="imgshow">
        ...
        <a href="<?php echo base_url().$dir['original'].$images[0]['original']; ?>" target="_blank" id="detimglink">
            <img class="imgdet" name="img_tag" src="<?php echo base_url().$dir['original'].$images[0]['original']; ?>" />
        </a>
        <?php } ?>
    </div>

<!--    <div id="imglist">
        <form enctype="multipart/form-data" id="fupload" method="post" action="<?php echo site_url('welcome/proyectos/4/'); ?>">
...
<!--            <div class="dadel">
        ...
        <div class="imgbox">
            <div>
<!--                <a href="javascript:" onclick="changepic('<?php echo base_url().$dir['original'].$img['original']; ?>', 'thumb_<?php echo $key; ?>');">-->
                <img class="thumb"  name="thumb" id="thumb_<?php echo $imgs['id_multimedia']; ?>" src="<?php echo base_url().$imgs['archivo']; ?>.jpg"/>
<!--                </a>-->
            </div>
<!--            <div class="dadel">
            <a class="adel" href="<?php echo site_url('image/delete/'.$img['original']); ?>">
